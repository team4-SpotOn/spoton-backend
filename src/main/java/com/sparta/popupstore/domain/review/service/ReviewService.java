...
public class ReviewService {
    ...
    public ReviewUpdateResponseDto updateReview(User user, Long reviewId, ReviewUpdateRequestDto updateRequestDto) {
        ...
        if(IsValidNullAndEmpty.isValidNullAndEmpty(review.getImageUrl()) &&!Objects.equals(review.getImageUrl(), updateRequestDto.getImageUrl())) {
    ...
    public void deleteReview(User user, Long reviewId){
        ...
        if(IsValidNullAndEmpty.isValidNullAndEmpty(review.getImageUrl())) {
            s3ImageService.deleteImage(review.getImageUrl());
        }
