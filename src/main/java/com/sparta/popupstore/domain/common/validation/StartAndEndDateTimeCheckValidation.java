...
@Slf4j
public class StartAndEndDateTimeCheckValidation implements ConstraintValidator<StartAndEndDateTimeCheck, Object> {
    private String message;
    private String startDateTime;
    private String endDateTime;

    @Override
    public void initialize(StartAndEndDateTimeCheck constraintAnnotation) {
    ...
    public boolean isValid(Object o, ConstraintValidatorContext constraintValidatorContext) {
        ...
        if(fieldStartTimeDate.isAfter(fieldEndDateTime) || fieldStartTimeDate.isBefore(now.plusDays(1))) {
        ...
        if(fieldEndDateTime.isBefore(now)) {
            constraintValidatorContext
                    .buildConstraintViolationWithTemplate("종료일은 현재 날짜보다 이후로 정하셔야합니다")
